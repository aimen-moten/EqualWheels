...
import { FaMapMarkerAlt, FaCarSide, FaCar, FaMoneyBill, FaDollarSign, FaShuttleVan } from 'react-icons/fa';
    ...
    >
      {isAuthenticated && (
        ...
        <div className="grid grid-cols-12 gap-4 mt-4">
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 p-4 bg-gray-800 rounded-lg">
            <div className="flex items-center justify-center mb-4">
              ...
              <h2 className="text-lg font-semibold text-white">Request a Ride</h2>
            </div>
            <div className="h-64 bg-white rounded-lg" >
              <div className="h-64 flex text-center items-center justify-center text-4xl font-bold text-gray-800 mx-auto p-4">
                <Link to="/rider-request-form" >Submit a Ride Request</Link>
                <FaCarSide size={100} className='text-red-500' />
              </div>
            </div>
          </div>
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 p-4 bg-gray-800 rounded-lg">
            <div className="flex items-center justify-center mb-4">
              <FaMoneyBill size={36} className="text-green-500 mr-2" />
              <h2 className="text-lg font-semibold text-white">Manage Payments</h2>
            </div>
            <div className="h-64 bg-white rounded-lg" >
              <div className="h-64 flex text-center items-center justify-center text-4xl font-bold text-gray-800 mx-auto">
                <Link to="/rider-payments" >
                  <FaDollarSign size={100} className='text-green-700' />
                </Link>
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 p-4 bg-gray-800 rounded-lg">
            <div className="flex items-center justify-center mb-4">
              <FaCar size={36} className="text-pink-500 mr-2" />
              <h2 className="text-lg font-semibold text-white">Your Rides History</h2>
            </div>
            <div className="h-64 bg-white rounded-lg" >
              <div className="h-64 flex text-center items-center justify-center text-4xl font-bold text-gray-800 mx-auto">
                <Link to="/rider-history" >
                  <p>Your History</p>
                  <FaShuttleVan size={100} className='text-pink-700 mx-auto' />
                </Link>
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <h1 className="text-4xl font-bold text-center mb-6 text-yellow-600">Rider Dashboard</h1>
          <p className="text-gray-100 text-center mb-8">
            Here, you can manage your rides and view your profile.
          </p>
          <motion.div
